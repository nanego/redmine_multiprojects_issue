...
This plugin has been tested with Redmine 2.3.0+, but the current master is only compatible with Redmine 2.3.3+. See below for specific instructions.
...
If you are runnning Redmine 2.3.0 to 2.3.2, you need to download or clone [v0.2](https://github.com/nanego/redmine_multiprojects_issue/releases/tag/v0.2). If you are running Redmine 2.3.3+, download or clone the current master.
